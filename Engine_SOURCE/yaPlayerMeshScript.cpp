...
#pragma region 1차 통합
               /* meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_000000.fbx", L"a000_000000_" + name);
                ...
                meshData->AnimationSave(L"Player\\AnimationData\\a000_" + name + L".animationdata");*/
                ...
                meshData->AnimationSave(L"Player\\AnimationData\\a050_" + name + L".animationdata");
...
#pragma endregion
        ...
        else
        {
            for (auto iter = mMeshDataMap.begin(); iter != mMeshDataMap.end(); iter++)
            {
                ...
                meshData->AnimationLoad(L"Player\\AnimationData\\a000_" + name + L".animationdata", nullptr, false);
                meshData->AnimationLoad(L"Player\\AnimationData\\a050_" + name + L".animationdata");
            }
        }
    }
