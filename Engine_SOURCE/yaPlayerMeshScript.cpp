...
namespace ya
{
    ...
    void PlayerMeshScript::Initialize()
    {
        ...
        for (auto iter = mMeshDataMap.begin(); iter != mMeshDataMap.end(); iter++)
        {
            ...
            meshData->GetAnimationEndEvent(L"a000_000010") = [meshData]() { meshData->Play(L"a000_000000"); };
            meshData->GetAnimationEndEvent(L"a000_000011") = [meshData]() { meshData->Play(L"a000_000000"); };
            meshData->GetAnimationEndEvent(L"a000_000012") = [meshData]() { meshData->Play(L"a000_000000"); };
            meshData->GetAnimationEndEvent(L"a000_000013") = [meshData]() { meshData->Play(L"a000_000000"); };
