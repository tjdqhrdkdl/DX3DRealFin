...
#pragma region a000_000000 ~ a000_0015xx 걷기, 달
                /*
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_000000.fbx", L"a000_000000");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_000010.fbx", L"a000_000010");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_000011.fbx", L"a000_000011");
...
#pragma region a000_005xxx 웅크린 걷기
                /*
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005000.fbx", L"a000_005000");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005010.fbx", L"a000_005010");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005011.fbx", L"a000_005011");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005012.fbx", L"a000_005012");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005013.fbx", L"a000_005013");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005100.fbx", L"a000_005100");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005101.fbx", L"a000_005101");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005102.fbx", L"a000_005102");
                meshData->LoadAnimationFromFbx(L"Player\\Animation\\a000_005103.fbx", L"a000_005103");
...
#pragma region a000_11xxxx 피격, 사망, 
               /*
...
#pragma region a000_299xxx
                    ...
                    meshData->AnimationSave(L"Player\\AnimationData\\" + name + L"_a000_299xxx.animationdata");
                    */
#pragma endregion
...
#pragma region a000_412090
                    ...
                    meshData->AnimationSave(L"Player\\AnimationData\\" + name + L"_a000_412090.animationdata");
                    */
#pragma endregion
...
#pragma region a000_700xxx
                    ...
                    meshData->AnimationSave(L"Player\\AnimationData\\" + name + L"_a000_700xxx.animationdata");
                    */
#pragma endregion
...
#pragma region a000_71xxxx
                    ...
                    meshData->AnimationSave(L"Player\\AnimationData\\" + name + L"_a000_71xxxx.animationdata");
                    */
#pragma endregion
...
#pragma region a000_790xxx
                    ...
                    meshData->AnimationSave(L"Player\\AnimationData\\" + name + L"_a000_79xxxx.animationdata");
                                */
#pragma endregion
...
#pragma endregion
        ...
        else
        {
            for (auto iter = mMeshDataMap.begin(); iter != mMeshDataMap.end(); iter++)
            {
                ...
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a000_1.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a050_1.animationdata");

               // meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_01.animationdata");
               // meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_02.animationdata");

                /*meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a000_0015xx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a000_005xxx.animationdata");
                ...
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a000_412090.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a000_700xxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a000_71xxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a000_79xxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a010_xxxxxx.animationdata");
                
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a050_0xxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a050_1xxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a050_20xxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a050_3xxxxx.animationdata");
                
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a200_5xxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a201_51xxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a202_5xxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a21x_xxxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a22x_xxxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a23x_xxxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a24x_xxxxxx.animationdata");
                meshData->AnimationLoad(L"Player\\AnimationData\\" + name + L"_a25x_xxxxxx.animationdata");*/
            }
        }
    }
