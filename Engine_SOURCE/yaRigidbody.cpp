...
namespace ya
{
	...
	void Rigidbody::Initialize()
	{
		...
		mGroundCheckScript = obj->AddComponent<GroundCheckScript>();
	}
	...
	void Rigidbody::Update()
	{
		...
		//if (mGroundCheckScript->IsGround() && !mbJumping)
		...
		//if (mGroundCheckScript->IsGround())
		//{
		//	Vector3 dir = mCollider->GetVelocity();
 	...
 	//		velo.x = 0.f;
		...
		//if (ForwardCheck(mCollider->GetVelocity()))
		//{
	...
	{
		return mGroundCheckScript->IsGround();
	}
}