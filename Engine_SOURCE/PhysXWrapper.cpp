...
//			transform->SetLocalPosition(Vector3::Transform(transform->GetWorldPosition(), rotation) + position);
...
//		t.q = MathUtil::quaternionToPx(component->GetLocalRotationQuaternion());
//
//
//		if (isStatic)
//		{
...
//		t.q = *outShape ? MathUtil::quaternionToPx(component->GetLocalRotationQuaternion()) : MathUtil::quaternionToPx(component->GetLocalRotationQuaternion());
//
//		if (isStatic)
//		{
